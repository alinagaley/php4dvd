...
from ini.pages.user_management_page import UserManagementPage
from ini.pages.internal_page import InternalPage
from ini.model.user import User
from ini.pages.user_profile_page import UserProfilePage
from ini.pages.add_movie_page import AddMoviePage
from ini.model.movie import Movie
from ini.pages.login_page import LoginPage
...
class Application(object):
    ...
    def logout(self):
        self.internal_page.logout_button.clock()
    ...
    def add_movie(self, movie):
        ...
        amp.is_this_page
        amp.add_movie_form.movie_title_field.send_keys(movie.title)
        amp.add_movie_form.movie_year_field.send_keys(movie.year)
        amp.add_movie_form.submit_button.click()
